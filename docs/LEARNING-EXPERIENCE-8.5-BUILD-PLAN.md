...
**Status:** Wave 0 done, Wave 1 done, Wave 3 partial (LEARN-030, LEARN-032 to LEARN-035 done), Wave 4 partial (LEARN-040 done)

**Owner:** Ryan Roland Dabao

**Date:** 2026-08-16 (last reviewed 2026-09-16 against `5026313`)
...
- **Wave 3 (Tool practice and saved evidence):** Partial. LEARN-030 (STORY-134), LEARN-032 (STORY-136), LEARN-033 (STORY-135), LEARN-035 (STORY-137) shipped. LEARN-031 (scenario packs) and LEARN-034 (tool-debrief autosave) not started.
...
| LEARN-021 | Ship the voice and active-practice pass for Module 0.                                                   | LEARN-020            | Module 0 content                                       | All onboarding lessons follow the production schema and pass the read-aloud review. 0.1 and 0.2 now include decision, worked-example, active-attempt, and feedback blocks; current course availability is explicit.                             |
| LEARN-022 | Ship the voice and active-practice pass for Module 1.                                                   | LEARN-020            | Module 1 content                                       | Every quantitative concept has a worked calculation and an independent calculation. Each Module 1 lesson now labels its independent calculation before the learner attempt.                                                                     |
| LEARN-023 | Ship the voice, visual, and practice pass for Module 2.                                                 | LEARN-020            | Module 2 content, match-type visual                    | Keyword lessons finish with a usable keyword grouping decision. Each lesson now names the grouping output and rationale to record.                                                                                                              |
| LEARN-024 | Ship the voice, visual, and practice pass for Module 3.                                                 | LEARN-020            | Module 3 content, Listing Audit bridge                 | Listing lessons finish with an audit rationale, not just a tool link. Each lesson now requires the evidence, recommendation, reason, and follow-up check that belong in the Listing-Readiness Audit.                                            |
| LEARN-025 | Ship the voice, visual, and practice pass for Module 4.                                                 | LEARN-020, STORY-127 | Module 4 content, Campaign Builder bridge              | Campaign structure lessons finish with a campaign map and pre-flight rationale. Each lesson now adds its decision to a build-ready map with ownership, budget, eligibility, negatives, and a review trigger.                                    |
| LEARN-026 | Ship the voice, visual, and practice pass for Module 5. Add the client-reporting and escalation bridge. | LEARN-020, STORY-128 | Module 5 content, reporting assignment                 | Portfolio, budget, and seasonality decisions lead to a weekly client readout. Each lesson now ends with a readout template plus a PHP-worked rationale, and the seasonal lesson adds an escalation line for stockout, margin, and cap breaches. |
