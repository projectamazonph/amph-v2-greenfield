...
Wiring diagrams for AMPH, drawn against what is actually in the repo — not the aspirational target design in `docs/build-spec.md`. See `CLAUDE.md` §"Known gaps" for the prose version of the same facts.
