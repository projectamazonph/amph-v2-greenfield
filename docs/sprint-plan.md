...
| ID        | Title                                             | Pts | Status                                                                                                                         |
| --------- | ------------------------------------------------- | --- | ------------------------------------------------------------------------------------------------------------------------------ |
| STORY-085 | Scenario publishing + versioning                  | 1   | ◐ done — versioning half only, see `docs/stories/STORY-085.md` "Scope note" (draft/publish lifecycle split out as a follow-up) |
