...
| ID | Title | Pts |
|----|-------|-----|
| STORY-011 | Course + Module + Lesson + PricingTier models + repos | 1 |
| STORY-012 | MDX content renderer port + adapter | 1 |
| STORY-013 | Content import script (`scripts/import-amph-content.ts`) reading from `content/curriculum/` | 1 |
| STORY-014 | RSC catalog page (`/courses`) + course detail page | 1 |
