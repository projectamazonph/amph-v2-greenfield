...
- **Voice:** a senior PPC specialist talking to a junior one. Direct, plain-spoken, real ₱ numbers and real percentages, not abstractions. No hype words ("unlock," "leverage," "seamless," "next-level," "revolutionize," "game-changing"). No filler questions to camera. Active voice, short sentences.
