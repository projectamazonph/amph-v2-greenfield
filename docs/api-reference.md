...
| Checkout and access       | `CreatePaymentIntent`, `ApplyDiscountCode`, `EnrollStudent`, `CheckCourseAccess`, `AuthorizeLessonAccess`, `ProcessRefund`, `RequestRefund`                                                                                                                                          |
...
| Learning                  | `RecordQuizAttempt`, `AwardXP`, `AwardBadge`, `ListUserBadges`, `RecordStreakVisit`, `MarkLessonComplete`                                                                                                                                                                            |
...
| Email and reminders       | `ListEmailTemplates`, `GetEmailTemplate`, `UpdateEmailTemplate`, `SendLiveClassReminders`                                                                                                                                                                                            |
