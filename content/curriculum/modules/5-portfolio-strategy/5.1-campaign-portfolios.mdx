...
After this lesson, you can decide whether an account has grown past the point where individual campaign management works. You can build a portfolio and budget-allocation structure without mixing up portfolio-level budget controls with campaign-level bids and negative keywords.
...
:::portfolio-map{id="portfolio-control-map" title="Map the portfolio budget without losing campaign control"}
{"note":"Portfolio budgets organize shared spend; bids and negatives still live inside each campaign. Do not confuse the group cap with automatic reallocation.","groups":[{"id":"core","label":"Core Products","share":"60%","purpose":"Always-on profit generators with stable efficiency expectations.","campaigns":[{"id":"core-broad","label":"SP · Bamboo Board · Broad","purpose":"Discovery","budget":"₱24,000","bidLogic":"Low, controlled bid"},{"id":"core-phrase","label":"SP · Bamboo Board · Phrase","purpose":"Scaling","budget":"₱21,000","bidLogic":"Medium bid"},{"id":"core-exact","label":"SP · Bamboo Board · Exact","purpose":"Protection","budget":"₱12,000","bidLogic":"Highest bid"}]},{"id":"launch","label":"New Launches","share":"20%","purpose":"Fund discovery and growth with a higher ACoS tolerance.","campaigns":[{"id":"launch-auto","label":"SP · New Product A · Auto","purpose":"Discovery","budget":"₱12,000","bidLogic":"Low-to-medium bid"},{"id":"launch-broad","label":"SP · New Product C · Broad","purpose":"Research","budget":"₱8,000","bidLogic":"Low bid"}]},{"id":"brand","label":"Brand Defense","share":"10%","purpose":"Protect branded demand from competitor pressure.","campaigns":[{"id":"brand-exact","label":"SP · Brand Name · Exact","purpose":"Defense","budget":"₱6,000","bidLogic":"High-intent bid"},{"id":"brand-sb","label":"SB · Brand Awareness","purpose":"Coverage","budget":"₱4,000","bidLogic":"Placement-aware bid"}]},{"id":"seasonal","label":"Seasonal & Promo","share":"10%","purpose":"Hold time-bound spend for events and promotions.","campaigns":[{"id":"seasonal-holiday","label":"SP · Holiday Campaign","purpose":"Event capture","budget":"₱6,000","bidLogic":"Ramp by phase"},{"id":"seasonal-prime","label":"SP · Prime Day Prep","purpose":"Pre-event","budget":"₱4,000","bidLogic":"Test then scale"}]}]}
:::
...
Set portfolio budgets 10-20% higher than your expected combined spend for the period. This gives the group room to flex on good days without the whole portfolio hitting its cap and pausing early.
...
Portfolios are for when you have so many balls in the air that you need buckets to organize them. One ball? Just hold it. Ten balls? Get buckets. Fifty balls? Get a color-coded bucket system with labels.
...
Use a short prefix tag to make portfolio names instantly scannable, the same way you'd label folders in a filing cabinet:
...
Your client's account has grown to 16 campaigns across three product lines:

- **Insulated tumblers**: an established bestseller.
- **Yoga mats**: launched two months ago, still building conversion data.
- **Resistance bands**: a brand-new SKU launching next month.

Total monthly ad budget is ₱150,000. The client also asks you to set up "one negative keyword list for all the yoga mat campaigns at once." The point is to avoid entering the same negatives three times. Before reading further:

- Should this account move to portfolios?
- How would you roughly split the ₱150,000 across the three product lines, using the logic from this lesson?
- How do you answer the client's request for one shared negative list?
...
## Your worksheet: start your Budget Decision Log

Part 1 of the Budget Decision Log, the required artifact for this module.

```text
Account or product line: ____________________
Total campaign count: ____________________
Move to portfolios? (yes if 10+): ____________________
Portfolio names and rough budget split: ____________________
Which controls stay campaign-level, not portfolio-level (bids, negatives): ____________________
```

## Weekly client readout

Turn Part 1 of the Budget Decision Log into a readout a client can act on. Add one line per portfolio:

```text
Portfolio | Share of budget | Amount | Purpose | Review trigger
_________ | _______________ | ______ | _______ | ______________
```

Then write your readout rationale in three sentences. The first sentence must state the split and why the proven line gets the largest share. The second must name which controls stay at the campaign level. The third must name the first signal you will review before moving budget.

For the 16-campaign account, a usable rationale is: "Tumblers get ₱90,000 (60%) because they are the proven bestseller. Yoga mats get ₱37,500 (25%) while they build conversion data, and resistance bands start at ₱22,500 (15%) until launch data arrives. Bids and negatives stay inside each campaign, so the shared list goes into every yoga mat campaign separately; I will review spend and conversion by portfolio before moving budget."
