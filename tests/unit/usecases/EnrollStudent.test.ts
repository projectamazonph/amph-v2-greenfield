...
describe("EnrollStudent", () => {
  ...
  it("enrolls user and returns enrollment", async () => {
    ...
    // Proposal 8: EnrollStudent no longer writes User.enrolledCourseIds —
    // Enrollment is the sole source of truth, and TierAccessPolicy reads
    // it directly instead of this denormalized copy.
