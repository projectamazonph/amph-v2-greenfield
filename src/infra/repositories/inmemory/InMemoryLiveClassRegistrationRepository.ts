 ...
 */
export class InMemoryLiveClassRegistrationRepository
  implements ILiveClassRegistrationRepository
{
  ...
  async findByUserAndClass(
    ...
    Result<LiveClassRegistration | null, LiveClassRegistrationRepositoryError>
  > {
