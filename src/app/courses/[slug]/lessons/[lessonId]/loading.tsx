...
export default function LessonLoading() {
  return (
    <div style={{ display: 'flex', minHeight: '100vh' }}>
      <div style={{ width: 280, flexShrink: 0, padding: 'var(--space-6)', borderRight: '1px solid var(--border)' }}>
      ...
      <div style={{ flex: 1, padding: 'var(--space-8) var(--side-pad)', maxWidth: 720 }}>
        ...
        <div style={{ marginTop: 'var(--space-4)' }}><SkeletonBlock width='80%' height='2rem' variant='text' /></div>
