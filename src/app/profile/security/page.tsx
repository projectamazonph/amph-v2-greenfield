...
const twoFactorErrorMessage: Record<string, string> = {
  ...
  user_not_found: "We could not find your account. Your 2FA settings are unchanged. Sign in again and try once more.",
  db_error: "We could not update your security settings. Your 2FA state is unchanged. Try again in a moment.",
};
