 ...
 *
 * The form creates the initial curriculum; the course detail page then
  ...
  return (
    <div>
      ...
      <form action={handleSubmit} className={styles.form}>
        ...
        <Card padding={6}>
          <h2 className={styles.sectionTitle}>Initial curriculum</h2>
          <p className={styles.help}>
            Start with one section and lesson. After creation, use the course page to add, edit,
            reorder, or remove modules and lessons.
          </p>
          <div className={styles.grid}>
            <label className={styles.field}>
