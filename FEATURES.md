...
**Last reviewed:** 2026-08-16 against the student-facing UI round 29 branch (PR #TBD)
...
| Learning-experience uplift   | Partial              | Wave 0 now has a checked-in curriculum inventory, durable planned learner time, and a public-claim contract for module counts, tier/tool inclusion, lesson minutes, and certificate wording (`STORY-111`–`STORY-113`). Zero-to-one onboarding, evidence-linked practice, and the rubric-backed capstone remain in the build plan. Existing simulator scores remain formative. |
